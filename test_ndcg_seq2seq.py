...
def train(config):
    ...
    print("\n\nStarting NDCG Test at : ",datetime.now().strftime("%Y-%m-%d %H:%M"))
    ...
    with open('dataset/seq2seq_ndcg_at_1'+config.representation,'wb') as f1:
        pickle.dump(ndcg_at_1, f1)
    with open('dataset/seq2seq_ndcg_at_3'+config.representation,'wb') as f2:
        pickle.dump(ndcg_at_3, f2)
    with open('dataset/seq2seq_ndcg_at_5'+config.representation,'wb') as f3:
        pickle.dump(ndcg_at_5, f3)
    with open('dataset/seq2seq_ndcg_at_10'+config.representation,'wb') as f4:
